...
| 模块 | 主题                      | 题目数量 | 难度   | 状态   |
| ---- | ------------------------- | -------- | ------ | ------ |
| 一   | Tensor 的创建与属性 ✨    | 约 10 题 | ⭐     | 进行中 |
| 二   | 索引、切片与形状变换 🔪   | 约 25 题 | ⭐⭐   | 进行中 |
| 三   | 数学与逻辑运算 🧮         | 约 25 题 | ⭐⭐   | 未开始 |
| 四   | 广播机制 📡               | 约 20 题 | ⭐⭐⭐ | 未开始 |
| 五   | nn.Module 与基础层入门 🏗️ | 约 10 题 | ⭐⭐⭐ | 未开始 |
| 六   | Autograd 自动求导引擎 🔥  | 约 10 题 | ⭐⭐⭐ | 未开始 |
...
- **ResNet**: 实现一个包含残差连接的 Block
- **GAN**: 创建噪声向量，理解判别器和生成器的输入输出
- **手动实现卷积**: 使用底层操作模拟 `nn.Conv2d`
</details>
